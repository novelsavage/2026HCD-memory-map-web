...
床を復活させたくなった場合の根本解決は「地形追従グラウンド」:
キャンパス縁の実高さを footprint 境界セルでサンプリング → 距離減衰で
基準高さへブレンドした heightfield を市街地の地面にし、道路・建物も
その高さに追従させる。工数 ~1 日。輪郭を綺麗に切りたいだけなら
footprint に marching squares + 単純化で輪郭ポリゴン化する手もある。
